...
class PayWallScreen: UIViewController {
    ...
    @objc func sendButtonViewTapped() {
    ...
    func setupUI() {
        ...
        closeButtonImg.image = UIImage(named: "close-paywall")
        ...
        subTitleLbl.text = "Enjoy unlimited\nconnection to your service"
        ...
        threeDaysSubLbl.text = "$4.99 per week"
        treeDaysCheckImg.image = UIImage(named: "check-disable-paywall")
        ...
        yearlySubLbl.text = "$29.99 per year"
        yearlyChechImg.image = UIImage(named: "check-disable-paywall")
        ...
        sendButtonView.backgroundColor = UIColor(hexString: "#FF8500")
        sendButtonView.layer.cornerRadius = 28
        sendButtonView.layer.shadowColor = UIColor(hexString: "#FF8500").withAlphaComponent(0.67).cgColor
    ...
    func updateViewSelection(isThreeDaysSelected: Bool) {
        if isThreeDaysSelected {
            ...
            threeDaysView.layer.borderColor = UIColor(hexString: "FF8500").cgColor
            treeDaysCheckImg.image = UIImage(named: "check-enable-paywall")
            threeDaysView.layer.shadowColor = UIColor.gray.withAlphaComponent(0.5).cgColor
            threeDaysView.layer.shadowOpacity = 0.8
            threeDaysView.layer.shadowRadius = 2.0
            threeDaysView.layer.shadowOffset = CGSize(width: 2.0, height: 2.0)
            ...
            yearlyView.layer.borderColor = UIColor(hexString: "#FF8500").cgColor
            yearlyChechImg.image = UIImage(named: "check-enable-paywall")
